...
Pod::Spec.new do |s|
  ...
  s.name         = "CZHAToolKits"
  s.version      = "0.0.2"
  s.summary      = "A short description of CZHAToolKits."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/CZHAToolKits"
  ...
  s.source       = { :git => "https://github.com/appledev201888/CZHAToolKits.git", :tag => "#{s.version}" }
